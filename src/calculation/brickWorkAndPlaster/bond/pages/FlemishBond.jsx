...
// Import icons
import flemishBonds from '../../../../assets/icons/flemishBonds.svg';
...
const FlemishBond = () => {
    ...
    const w_wall = L_m; // Flemish bond (1-brick wall)
    ...
    return (
        <div className="min-h-screen max-w-7xl mx-auto pb-20">
            <div className="mb-6">
                <PageHeader
                    title={t('brickWorkAndPlaster.bonds.flemishTitle')}
                    showBackButton
                    onBack={() => navigate(-1)}
                >
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    <div className="flex items-center justify-center">
                        <img src={flemishBonds} alt={t('brickWorkAndPlaster.bonds.flemishTitle')} className="object-contain" />
                    </div>
                </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Button variant="primary" onClick={() => navigate(ROUTES_FLAT.CALCULATION_FLEMISH_BOND_DETAILED, { state: { calculationData, outputs: detailedOutputs } })} className="!rounded-2xl text-lg font-medium hover:bg-[#B02E0C] transition-all h-[58px]">{t('steel.weight.viewDetailed')}</Button>
                    </div>
                </div>
            )}
            ...
            <DownloadPDFModal
                ...
                defaultTitle={t('brickWorkAndPlaster.bonds.flemishDetailedTitle')}
