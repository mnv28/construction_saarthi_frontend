...
// Import icons
import headerBonds from '../../../../assets/icons/headerBonds.svg';
...
const HeaderBond = () => {
    ...
    const w_wall = L_m; // In Header bond, wall thickness = brick length
    ...
    // No of Bricks = V / (Lx(W+j)x(T+j))
    const unitVol = L_m * (W_m + J_m) * (T_m + J_m);
    ...
    const detailedOutputs = [
        ...
        },
        {
            ...
            labelSuffix: '=',
            formula: '((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))/(LX(W+j)x(T+j))',
        ...
        },
        {
            ...
            labelSuffix: '=',
            formula: '(((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))-(((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))/(LX(W+j)x(T+j)))xLxWxT))x1.42',
        ...
        },
        {
            ...
            labelSuffix: '=',
            formula: '(cX(((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))-(((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))/(LX(W+j)x(T+j)))xLxWxT))x1.42)/((c+s)X0.035)',
        ...
        },
        {
            ...
            labelSuffix: '=',
            formula: '(B1x((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))/(LX(W+j)x(T+j)))',
        ...
        },
        {
            ...
            labelSuffix: '=',
            formula: '(C1x(cX(((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))-(((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))/(LX(W+j)x(T+j)))xLxWxT))x1.42)/((c+s)X0.035))',
        ...
        },
        {
            ...
            labelSuffix: '=',
            formula: '(S1x(sX(((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))-(((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))/(LX(W+j)x(T+j)))xLxWxT))x1.42)/(c+s))',
        ...
        },
        {
            ...
            labelSuffix: '=',
            formula: '(B1X((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))/(LX(W+j)X(T+j)))+(C1X(cX(((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))-(((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))/(LX(W+j)X(T+j)))XLXWXT))X1.42)/((c+s)X0.035))+(S1X(sX(((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))-(((lXhXw)-(W1XH1XT+W2XH2XT+W3XH3XT))/(LX(W+j)X(T+j)))XLXWXT))X1.42)/(c+s))',
    ...
    return (
        <div className="min-h-screen max-w-7xl mx-auto pb-20">
            <div className="mb-6">
                <PageHeader
                    title={t('brickWorkAndPlaster.bonds.headerTitle')}
                    showBackButton
                    onBack={() => navigate(-1)}
                >
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    <div className="flex items-center justify-center">
                        <img src={headerBonds} alt={t('brickWorkAndPlaster.bonds.headerTitle')} className="object-contain" />
                    </div>
                </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Button variant="primary" onClick={() => navigate(ROUTES_FLAT.CALCULATION_HEADER_BOND_DETAILED, { state: { calculationData, outputs: detailedOutputs } })} className="!rounded-2xl text-lg font-medium hover:bg-[#B02E0C] transition-all h-[58px]">{t('steel.weight.viewDetailed')}</Button>
                    </div>
                </div>
            )}
            ...
            <DownloadPDFModal
                ...
                defaultTitle={t('brickWorkAndPlaster.bonds.headerDetailedTitle')}
