...
// Import icons
import stretcherBonds from '../../../../assets/icons/stretcherBonds.svg';
...
const StretcherBond = () => {
    ...
    const w_wall = W_m; // In Stretcher bond, wall thickness = brick width
    ...
    // where w = wall thickness, T = wall thickness
    ...
    return (
        <div className="min-h-screen max-w-7xl mx-auto pb-20">
            <div className="mb-6">
                <PageHeader
                    title={t('brickWorkAndPlaster.bonds.stretcherTitle')}
                    showBackButton
                    onBack={() => navigate(-1)}
                >
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    <div className="flex items-center justify-center">
                        <img src={stretcherBonds} alt={t('brickWorkAndPlaster.bonds.stretcherTitle')} className="object-contain" />
                    </div>
                </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-4">
                            ...
                            <div className="col-span-2 md:col-span-1">
                                <InputField
                                    ...
                                    placeholder={t('brickWorkAndPlaster.bonds.brickToBrickJoint')}
                                />
                            </div>
                        </div>
                    </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                        ...
                        <table className="w-full text-left border-collapse min-w-[320px]">
                            ...
                            <tbody className="divide-y divide-[#060C120A]">
                                {[
                                    ...
                                    { material: t('brickWorkAndPlaster.clayBrick.results.sandCost'), quantity: sandVolume.toFixed(3), unit: '₹' },
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Button
                            variant="primary"
                            onClick={() => navigate(ROUTES_FLAT.CALCULATION_STRETCHER_BOND_DETAILED, {
                                state: {
                                    calculationData,
            ...
            <DownloadPDFModal
                ...
                defaultTitle={t('brickWorkAndPlaster.bonds.stretcherDetailedTitle')}
