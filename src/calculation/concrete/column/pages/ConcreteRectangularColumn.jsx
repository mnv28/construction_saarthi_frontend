...
import CrectangleIcon from "../../../../assets/icons/C2.svg";

const ConcreteRectangularColumn = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-6">
        <PageHeader
          title={t("concrete.column.rectangularColumn", { defaultValue: "Concrete of Rectangular Column" })}
          showBackButton
          onBack={() => navigate(-1)}
        >
      ...
      <div>
        <div className="bg-[#F9F4EE]  p-4 rounded-2xl">
        {/* Shape Illustration & Unit Selection */}
        <div className="border-b border-gray-200 pb-4 mb-4">
          <div className="flex flex-col md:flex-row items-center gap-6">
            {/* Rectangular Column Image */}
            <div className="flex-shrink-0">
                <img 
                  src={CrectangleIcon} 
                  alt="Rectangular Column" 
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <NumberInput
              placeholder={t("concrete.byVolume.width", { defaultValue: "Width" })}
              value={width}
                ...
                onClick={() =>
                  navigate("/calculation/concrete/by-volume/detailed", {
                    state: {
                      ...
                      rateOfConcrete,
                      unit,
                      pageTitle: t("concrete.column.rectangularColumn", { defaultValue: "Concrete of Rectangular Column" }),
                      ...results,
                    },
                  })
                }
      ...
      <DownloadPDFModal
        ...
        defaultTitle={t("concrete.column.rectangularColumn", { defaultValue: "Concrete of Rectangular Column" })}
      />
    </div>
  );
};

export default ConcreteRectangularColumn;
