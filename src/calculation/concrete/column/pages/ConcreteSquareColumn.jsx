...
import CsquareIcon from "../../../../assets/icons/C1.svg";

const ConcreteSquareColumn = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-6">
        <PageHeader
          title={t("concrete.column.squareColumn", { defaultValue: "Concrete of Square Column" })}
          showBackButton
          onBack={() => navigate(-1)}
        >
                ...
                onClick={() =>
                  navigate("/calculation/concrete/by-volume/detailed", {
                    state: {
                      ...
                      rateOfConcrete,
                      unit,
                      pageTitle: t("concrete.column.squareColumn", { defaultValue: "Concrete of Square Column" }),
                      ...results,
                    },
                  })
                }
      ...
      <DownloadPDFModal
        ...
        defaultTitle={t("concrete.column.squareColumn", { defaultValue: "Concrete of Square Column" })}
      />
    </div>
  );
};

export default ConcreteSquareColumn;
