...
import Cstone1Icon from "../../../../assets/icons/Cs1.svg";
import { ROUTES_FLAT } from "../../../../constants/routes";

const ConcreteCurbStone1 = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-6">
        <PageHeader
          title={t("concrete.curbedStone.curbStone1", { defaultValue: "Concrete of Curb Stone 1" })}
          showBackButton
          onBack={() => navigate(-1)}
        >
      ...
      <div>
        <div className="bg-[#F9F4EE] rounded-xl p-4">
          <div className="border-b border-gray-200 flex flex-col md:flex-row gap-6 pb-4 mb-4">
             <div>
                <img src={Cstone1Icon} alt="Curb Stone 1" className="w-32 object-contain" />
             </div>
                ...
                onClick={() =>
                  navigate(ROUTES_FLAT.CALCULATION_CONCRETE_BY_VOLUME_DETAILED, {
                    state: {
                      ...
                      rateOfConcrete,
                      unit,
                      pageTitle: t("concrete.curbedStone.curbStone1", {
                        defaultValue: "Concrete of Curb Stone 1",
                      }),
                      ...results,
                    },
                  })
      ...
      <DownloadPDFModal
        ...
        defaultTitle={t("concrete.curbedStone.curbStone1", { defaultValue: "Concrete of Curb Stone 1" })}
      />
    </div>
  );
};

export default ConcreteCurbStone1;
