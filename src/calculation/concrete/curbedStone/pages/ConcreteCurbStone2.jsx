...
const ConcreteCurbStone2 = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-6">
        <PageHeader
          title={t("concrete.curbedStone.curbStone2", { defaultValue: "Concrete of Curb Stone 2" })}
          showBackButton
          onBack={() => navigate(-1)}
        >
      ...
      <div>
        <div className="bg-[#F9F4EE] rounded-xl p-4">
          <div className="border-b border-gray-200 flex flex-col md:flex-row gap-6 pb-4 mb-4">
             <div>
                <img src={Cstone2Icon} alt="Curb Stone 2" className="w-32 object-contain" />
             </div>
                ...
                onClick={() =>
                  navigate(ROUTES_FLAT.CALCULATION_CONCRETE_BY_VOLUME_DETAILED, {
                    state: {
                      ...
                      rateOfConcrete,
                      unit,
                      pageTitle: t("concrete.curbedStone.curbStone2", {
                        defaultValue: "Concrete of Curb Stone 2",
                      }),
                      ...results,
                    },
                  })
      ...
      <DownloadPDFModal
        ...
        defaultTitle={t("concrete.curbedStone.curbStone2", { defaultValue: "Concrete of Curb Stone 2" })}
      />
    </div>
  );
};

export default ConcreteCurbStone2;
