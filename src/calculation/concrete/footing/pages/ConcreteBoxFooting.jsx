...
import FoottingboxIcon from "../../../../assets/icons/Fb.svg";

const ConcreteBoxFooting = () => {
  ...
  const handleShare = () => {
    ...
    if (navigator.share) {
      navigator.share({
        title: t("concrete.footing.boxFooting", { defaultValue: "Concrete of Box Footing" }),
        text: "Concrete of Box Footing Calculation",
  ...
  return (
    <div className="max-w-7xl mx-auto">
                ...
                onClick={() =>
                  navigate("/calculation/concrete/by-volume/detailed", {
                    state: {
                      ...
                      rateOfConcrete,
                      unit,
                      pageTitle: t("concrete.footing.boxFooting", { defaultValue: "Concrete of Box Footing" }),
                      ...results,
                    },
                  })
                }
      ...
      <DownloadPDFModal
        ...
        defaultTitle={t("concrete.footing.boxFooting", { defaultValue: "Concrete of Box Footing" })}
      />
    </div>
  );
};

export default ConcreteBoxFooting;
