...
import FootingtrapezoidaIcon from "../../../../assets/icons/Ft.svg";

const ConcreteTrapezoidalFooting = () => {
  const { t } = useTranslation("calculation");
  const navigate = useNavigate();

  const [unit, setUnit] = useState("metric");
  const [baseLength, setBaseLength] = useState("");
  const [baseWidth1, setBaseWidth1] = useState("");
  const [baseWidth2, setBaseWidth2] = useState("");
  ...
  const handleShare = () => {
    ...
    if (navigator.share) {
      navigator.share({
        title: t("concrete.footing.trapezoidalFooting", { defaultValue: "Concrete of Trapezoidal Footing" }),
        text: "Concrete of Trapezoidal Footing Calculation",
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div>
        ...
        <div className="border-b border-gray-200 pb-4 mb-4">
          <div className="flex flex-col md:flex-row items-center gap-6">
            {/* Trapezoidal Footing Image */}
            <div className="flex-shrink-0">
                <img 
                  src={FootingtrapezoidaIcon} 
                  alt="Trapezoidal Footing" 
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            />
            <NumberInput
              placeholder={t("concrete.byVolume.width_W", { defaultValue: "Width - W1" })}
              value={baseWidth1}
              onChange={(e) => setBaseWidth1(e.target.value)}
              unit={unit === "metric" ? "m" : "ft"}
            />
          </div>
          <div className="grid grid-cols-2 gap-4">
            <NumberInput
              placeholder={t("concrete.byVolume.width_W", { defaultValue: "Width - W2" })}
              value={baseWidth2}
              onChange={(e) => setBaseWidth2(e.target.value)}
              unit={unit === "metric" ? "m" : "ft"}
            />
            <NumberInput
                ...
                onClick={() =>
                  navigate("/calculation/concrete/by-volume/detailed", {
                    state: {
                      ...
                      rateOfConcrete,
                      unit,
                      pageTitle: t("concrete.footing.trapezoidalFooting", { defaultValue: "Concrete of Trapezoidal Footing" }),
                      ...results,
                    },
                  })
                }
      ...
      <DownloadPDFModal
        ...
        defaultTitle={t("concrete.footing.trapezoidalFooting", { defaultValue: "Concrete of Trapezoidal Footing" })}
      />
    </div>
  );
};

export default ConcreteTrapezoidalFooting;
