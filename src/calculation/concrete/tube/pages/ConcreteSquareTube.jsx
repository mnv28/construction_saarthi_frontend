...
const ConcreteSquareTube = () => {
  ...
  const [tubeThicknessT, setTubeThicknessT] = useState("");
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-6">
        <PageHeader
          title={t("concrete.tube.squareTube", { defaultValue: "Concrete of Square Tube" })}
          showBackButton
          onBack={() => navigate(-1)}
        >
      ...
      <div>
        <div className="bg-[#F9F4EE] rounded-xl p-4">
          ...
          <div className="space-y-4">
            ...
            />
            <NumberInput
              placeholder={t("concrete.byVolume.tubeThickness_T", { defaultValue: "Tube Thickness - T" })}
              value={tubeThicknessT}
              onChange={(e) => setTubeThicknessT(e.target.value)}
              unit={unit === "metric" ? "m" : "ft"}
            />
      ...
      <DownloadPDFModal
        ...
        defaultTitle={t("concrete.tube.squareTube", { defaultValue: "Concrete of Square Tube" })}
      />
    </div>
  );
};

export default ConcreteSquareTube;
