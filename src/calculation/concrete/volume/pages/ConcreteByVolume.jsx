    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div>
        ...
        <div className="space-y-4">
          <NumberInput
            placeholder={t("concrete.byVolume.volume", { defaultValue: "Volume" })}
            value={volume}
                ...
                onClick={() =>
                  navigate("/calculation/concrete/by-volume/detailed", {
                    state: {
                      ...
                      rateOfConcrete,
                      unit,
                      pageTitle: t("concrete.byVolume.concreteByVolume", { defaultValue: "Concrete by Volume" }),
                      ...results,
                    },
                  })
                }
      ...
      <DownloadPDFModal
        ...
        defaultTitle={t("concrete.byVolume.concreteByVolume")}
      />
    </div>
  );
};

export default ConcreteByVolume;
