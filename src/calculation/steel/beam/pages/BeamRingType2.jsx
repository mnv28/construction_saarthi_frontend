...
// Import icons
import beamRingType2 from '../../../../assets/icons/beamRingType2.svg';
...
const BeamRingType2 = () => {
    ...
    const [columnSizeY, setColumnSizeY] = useState(''); // Y
    ...
    const H = parseFloat(columnHeightH) || 0; // in meters
    ...
    const part1 = (2 * (X - 80) + 2 * (Y - 80) + 20 * R) / 1000;
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center w-24 h-24 sm:w-38 sm:h-38">
                        <img src={beamRingType2} alt="Beam Ring Diagram" className="w-full h-full object-contain" />
                    </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Button
                            variant="primary"
                            onClick={() => navigate(ROUTES_FLAT.CALCULATION_BEAM_RING_TYPE2_DETAILED, {
                                state: {
                                    calculationData,
