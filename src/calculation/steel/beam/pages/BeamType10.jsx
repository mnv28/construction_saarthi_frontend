...
// Import icons
import beamType10 from '../../../../assets/icons/beamType10.svg';
...
const BeamType10 = () => {
    ...
    // No End Support Details for Beam Type 10
    ...
    // No Curtail Length (C) for Beam Type 10
    ...
    const totalSteel = topSteelWeight + bottomSteelWeightD2 + stirrupsWeight;
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center w-24 h-24 sm:w-38 sm:h-38">
                        <img src={beamType10} alt="Beam Diagram" className="w-full h-full object-contain" />
                    </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Button
                            variant="primary"
                            onClick={() => navigate(ROUTES_FLAT.CALCULATION_BEAM_TYPE10_DETAILED, {
                                state: {
                                    calculationData,
