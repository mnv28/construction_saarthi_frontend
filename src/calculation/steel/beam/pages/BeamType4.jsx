...
// Import icons
import beamType4 from '../../../../assets/icons/beamType4.svg';
...
const BeamType4 = () => {
    ...
    const [bottomD3, setBottomD3] = useState('');
    ...
    const D3 = parseFloat(bottomD3) || 0;
    ...
    // Bottom Steel (D3)
    const bottomSteelWeightD3 = ((L + 540) * 0.002) * D3 * D3 * n / 162.28;
    ...
    const totalSteel = topSteelWeight + bottomSteelWeightD2 + bottomSteelWeightD3 + stirrupsWeight;
    ...
    const calculationData = [
        ...
        { labelKey: 'steel.beam.bottomSteelD3', name: t('steel.beam.bottomSteelD3'), symbol: 'D3', value: `${bottomD3} mm` },
    ...
    const detailedOutputs = [
        ...
        {
            titleKey: 'steel.beam.bottomSteelD3',
            labelKey: 'steel.beam.bottomSteelD3',
            labelSuffix: '=',
            formula: '((L+540)X0.002)XD3XD3Xn/162.28',
            value: `${bottomSteelWeightD3.toFixed(3)} KG`
        },
        {
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center w-24 h-24 sm:w-38 sm:h-38">
                        <img src={beamType4} alt="Beam Diagram" className="w-full h-full object-contain" />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
                            ...
                            <InputField
                                unit="mm"
                                value={bottomD3}
                                onChange={(e) => setBottomD3(e.target.value)}
                                placeholder={t('steel.beam.bottomSteelD3')}
                            />
                        </div>
                    </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                        ...
                        <table className="w-full text-left border-collapse min-w-[320px]">
                            ...
                            <tbody className="divide-y divide-[#060C120A]">
                                {[
                                    ...
                                    { material: t('steel.beam.bottomSteelD3'), quantity: bottomSteelWeightD3.toFixed(3), unit: 'kg' },
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Button
                            variant="primary"
                            onClick={() => navigate(ROUTES_FLAT.CALCULATION_BEAM_TYPE4_DETAILED, {
                                state: {
                                    calculationData,
