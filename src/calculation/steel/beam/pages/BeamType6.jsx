...
// Import icons
import beamType6 from '../../../../assets/icons/beamType6.svg';
...
const BeamType6 = () => {
    ...
    // Curtail Details
    const [curtailSteelD3, setCurtailSteelD3] = useState('');
    const [curtailLengthCL, setCurtailLengthCL] = useState('');
    ...
    const D3 = parseFloat(curtailSteelD3) || 0; // Curtail Steel Diameter
    const C = parseFloat(curtailLengthCL) || 0; // Curtail Length
    ...
    // Curtail Length (C) - Actually Weight
    const curtailSteelWeight = (C * 0.001) * D3 * D3 * n / 162.28;
    ...
    const calculationData = [
        ...
        { labelKey: 'steel.beam.curtailSteelD3', name: t('steel.beam.curtailSteelD3'), symbol: 'D3', value: `${curtailSteelD3} mm` },
        { labelKey: 'steel.beam.curtailLengthCL', name: t('steel.beam.curtailLengthCL'), symbol: 'C', value: `${curtailLengthCL} mm` },
    ...
    const detailedOutputs = [
        ...
        },
        {
            ...
            labelSuffix: '=',
            formula: 'CX0.001XD3XD3Xn/162.28',
        ...
        <div className="min-h-screen max-w-7xl mx-auto pb-20">
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                ...
                <div className="space-y-4 pt-4">
                    ...
                    {/* Curtail Details Section */}
                    <div className="space-y-2">
                        <h3 className="font-medium text-primary ml-1">{t('steel.beam.curtailDetails')}</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
                            <InputField
                                unit="mm"
                                value={curtailSteelD3}
                                onChange={(e) => setCurtailSteelD3(e.target.value)}
                                placeholder={t('steel.beam.curtailSteelD3')}
                            />
                            <InputField
                                unit="mm"
                                value={curtailLengthCL}
                                onChange={(e) => setCurtailLengthCL(e.target.value)}
                                placeholder={t('steel.beam.curtailLengthCL')}
                            />
                        </div>
                    </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Button
                            variant="primary"
                            onClick={() => navigate(ROUTES_FLAT.CALCULATION_BEAM_TYPE6_DETAILED, {
                                state: {
                                    calculationData,
