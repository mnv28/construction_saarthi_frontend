...
// Import icons
import beamType9 from '../../../../assets/icons/beamType9.svg';
...
const BeamType9 = () => {
    ...
    const calculationData = [
        ...
        { labelKey: 'steel.beam.endSupportD3', name: 'End Support D3', symbol: 'D3', value: `${endSupportD3} mm` },
        { labelKey: 'steel.beam.endSupportLengthCL', name: 'End Support Length CL', symbol: 'C', value: `${endSupportLengthCL} mm` },
    ...
    const detailedOutputs = [
        ...
        {
            title: 'Curtail Length (C)',
            label: 'Curtail Length (C) =',
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center w-24 h-24 sm:w-38 sm:h-38">
                        <img src={beamType9} alt="Beam Diagram" className="w-full h-full object-contain" />
                    </div>
                ...
                <div className="space-y-4 pt-4">
                    ...
                    <div className="space-y-2">
                        <h3 className="font-medium text-primary ml-1">End Support Details</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
                            <InputField
                                unit="mm"
                                value={endSupportD3}
                                onChange={(e) => setEndSupportD3(e.target.value)}
                                placeholder="End support D3"
                            />
                            <InputField
                                unit="mm"
                                value={endSupportLengthCL}
                                onChange={(e) => setEndSupportLengthCL(e.target.value)}
                                placeholder="End support length CL"
                            />
                        </div>
                    </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                        ...
                        <table className="w-full text-left border-collapse min-w-[320px]">
                            ...
                            <tbody className="divide-y divide-[#060C120A]">
                                {[
                                    ...
                                    { material: 'Curtail Length (C)', quantity: curtailSteelWeight.toFixed(3), unit: 'Kg' },
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Button
                            variant="primary"
                            onClick={() => navigate(ROUTES_FLAT.CALCULATION_BEAM_TYPE9_DETAILED, {
                                state: {
                                    calculationData,
