...
const ColumnType5 = () => {
    ...
    // Vertical Steel (D1) - Formula: 6*D1*D1*H*N/162.28 
    const weightD1 = (6 * D1 * D1 * H * nColumns) / 162.28;

    // Vertical Steel (D2) - Formula: 4*D2*D2*H*N/162.28
    ...
    const calculationOutputs = [
        ...
        },
        {
            ...
            labelSuffix: ' =',
            formula: '(6XD1XD1XHXn/162.28)+(4XD2XD2XHXn/162.28)+(((2X(X-80)+2X(Y-80)+20XR1)/1000)X((1000XH/S)+1)X(R1XR1/162.28)Xn)+((((2X(X-80)/3)+2X(Y-80)+20XR2)/1000)X((1000XH/S)+1)X(R2XR2/162.28)Xn)',
        ...
        },
        {
            ...
            labelSuffix: ' =',
            formula: '((6XD1XD1XHXn/162.28)+(4XD2XD2XHXn/162.28)+(((2X(X-80)+2X(Y-80)+20XR1)/1000)X((1000XH/S)+1)X(R1XR1/162.28)Xn)+((((2X(X-80)/3)+2X(Y-80)+20XR2)/1000)X((1000XH/S)+1)X(R2XR2/162.28)Xn))Xr',
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center w-24 h-24 sm:w-38 sm:h-38">
                        <img src={colType5} alt="Column Type 5 Diagram" className="w-full h-full object-contain" />
                    </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Button
                            variant="primary"
                            onClick={() => navigate(ROUTES_FLAT.CALCULATION_COLUMN_TYPE5_DETAILED, {
                                state: {
                                    calculationData,
