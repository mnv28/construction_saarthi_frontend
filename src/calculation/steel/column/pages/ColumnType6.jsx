...
const ColumnType6 = () => {
    ...
    // Formulas based on Image
    // Volume
    const colVolume = (X * Y * H_mm * nColumns) / 1000000000;

    // Vertical Steel (D) - Formula: 12XDXDXHXn/162.28
    const weightD = (12 * D * D * H * nColumns) / 162.28;

    // Stirrups (R1) - Outer Ring
    ...
    // Stirrups (R3) - Inner Loop 2
    // Formula: (((2X(X-80)/3)+2X(Y-80)+20XR3)/1000)X((1000XH/S)+1)X(R3XR3/162.28)Xn
    // Same structure as R2
    const cuttingLengthR3 = (((2 * (X - 80)) / 3) + (2 * (Y - 80)) + (20 * R3)) / 1000;
    const weightPerR3 = (R3 * R3) / 162.28;
    const stirrupWeightR3 = cuttingLengthR3 * numStirrups * weightPerR3 * nColumns;

    const totalSteel = weightD + stirrupWeightR1 + stirrupWeightR2 + stirrupWeightR3;
    ...
    const calculationData = [
        ...
        { labelKey: 'steel.column.diameter', labelSuffix: ' D', name: t('steel.column.diameter') + " D", symbol: 'D', value: `${diameterD} mm` },
    ...
    const calculationOutputs = [
        ...
        },
        {
            ...
            labelSuffix: '(D) =',
            formula: '12XDXDXHXn/162.28',
            value: `${weightD.toFixed(3)} KG`
        },
        {
        ...
        },
        {
            ...
            labelSuffix: ' =',
            formula: '(12XDXDXHXn/162.28)+(((2X(X-80)+2X(Y-80)+20XR1)/1000)X((1000XH/S)+1)X(R1XR1/162.28)Xn)+((((2X(X-80)/3)+2X(Y-80)+20XR2)/1000)X((1000XH/S)+1)X(R2XR2/162.28)Xn)+((((2X(X-80)/3)+2X(Y-80)+20XR3)/1000)X((1000XH/S)+1)X(R3XR3/162.28)Xn)',
        ...
        },
        {
            ...
            labelSuffix: ' =',
            formula: '((12XDXDXHXn/162.28)+(((2X(X-80)+2X(Y-80)+20XR1)/1000)X((1000XH/S)+1)X(R1XR1/162.28)Xn)+((((2X(X-80)/3)+2X(Y-80)+20XR2)/1000)X((1000XH/S)+1)X(R2XR2/162.28)Xn)+((((2X(X-80)/3)+2X(Y-80)+20XR3)/1000)X((1000XH/S)+1)X(R3XR3/162.28)Xn))XR',
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center w-24 h-24 sm:w-38 sm:h-38">
                        <img src={colType6} alt="Column Type 6 Diagram" className="w-full h-full object-contain" />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex bg-white rounded-2xl border border-[#060C121A] focus-within:border-accent/40 transition-all overflow-hidden h-[50px] sm:h-[58px]">
                            ...
                            <input
                                ...
                                className="flex-1 px-3 sm:px-6 text-sm sm:text-base text-primary focus:outline-none"
                                placeholder={t('steel.column.diameter') + " D"}
                            />
                        </div>
                    </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Button
                            variant="primary"
                            onClick={() => navigate(ROUTES_FLAT.CALCULATION_COLUMN_TYPE6_DETAILED, {
                                state: {
                                    calculationData,
