...
const ColumnType7 = () => {
    ...
    // Vertical Steel (D1) - Formula: 6XD1XD1XHXn/162.28
    const weightD1 = (6 * D1 * D1 * H * nColumns) / 162.28;

    // Vertical Steel (D2) - Formula: 8XD2XD2XHXn/162.28
    const weightD2 = (8 * D2 * D2 * H * nColumns) / 162.28;
    ...
    // Stirrups (R2)
    // Formula: (((6X(X-80)/5)+2X(Y-80)+20XR2)/1000)X((1000XH/S)+1)X(R2XR2/162.28)Xn
    const cuttingLengthR2 = (((6 * (X - 80)) / 5) + (2 * (Y - 80)) + (20 * R2)) / 1000;
    const weightPerR2 = (R2 * R2) / 162.28;
    const stirrupWeightR2 = cuttingLengthR2 * numStirrups * weightPerR2 * nColumns;

    // Stirrups (R3)
    // Formula: (((2X(X-80)/5)+2X(Y-80)+20XR3)/1000)X((1000XH/S)+1)X(R3XR3/162.28)Xn
    const cuttingLengthR3 = (((2 * (X - 80)) / 5) + (2 * (Y - 80)) + (20 * R3)) / 1000;
    ...
    const calculationOutputs = [
        ...
        },
        {
            ...
            labelSuffix: ' =',
            formula: '(6XD1XD1XHXn/162.28)+(8XD2XD2XHXn/162.28)+(((2X(X-80)+2X(Y-80)+20XR1)/1000)X((1000XH/S)+1)X(R1XR1/162.28)Xn)+((((6X(X-80)/5)+2X(Y-80)+20XR2)/1000)X((1000XH/S)+1)X(R2XR2/162.28)Xn)+((((2X(X-80)/5)+2X(Y-80)+20XR3)/1000)X((1000XH/S)+1)X(R3XR3/162.28)Xn)',
        ...
        },
        {
            ...
            labelSuffix: ' =',
            formula: '((6XD1XD1XHXn/162.28)+(8XD2XD2XHXn/162.28)+(((2X(X-80)+2X(Y-80)+20XR1)/1000)X((1000XH/S)+1)X(R1XR1/162.28)Xn)+((((6X(X-80)/5)+2X(Y-80)+20XR2)/1000)X((1000XH/S)+1)X(R2XR2/162.28)Xn)+((((2X(X-80)/5)+2X(Y-80)+20XR3)/1000)X((1000XH/S)+1)X(R3XR3/162.28)Xn))XR',
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    ...
                    <div className="flex items-center justify-center w-24 h-24 sm:w-38 sm:h-38">
                        <img src={colType7} alt="Column Type 7 Diagram" className="w-full h-full object-contain" />
                    </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Button
                            variant="primary"
                            onClick={() => navigate(ROUTES_FLAT.CALCULATION_COLUMN_TYPE7_DETAILED, {
                                state: {
                                    calculationData,
