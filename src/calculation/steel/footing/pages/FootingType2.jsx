...
import footType1 from '../../../../assets/icons/footType1.svg'; // Using type1 icon as placeholder if type2 not available
...
const FootingType2 = () => {
    ...
    const d3Weight = len1 * nos1 * w3 * n; // Example logic for D3
    const d4Weight = len2 * nos2 * w4 * n; // Example logic for D4

    const totalSteel = d1Weight + d2Weight + d3Weight + d4Weight;
    ...
    const calculationData = [
        ...
        { labelKey: 'steel.footing.d3', name: t('steel.footing.d3'), symbol: 'D3', value: `${d3} mm` },
        { labelKey: 'steel.footing.d4', name: t('steel.footing.d4'), symbol: 'D4', value: `${d4} mm` },
        ...
        { labelKey: 'steel.footing.s3', name: t('steel.footing.s3'), symbol: 'S3', value: `${s3} mm` },
        { labelKey: 'steel.footing.s4', name: t('steel.footing.s4'), symbol: 'S4', value: `${s4} mm` },
        ...
        <div className="min-h-screen max-w-7xl mx-auto pb-20">
            ...
            <div className="bg-[#F9F4EE] rounded-3xl p-4 sm:p-6">
                <div className="flex items-center gap-4 sm:gap-10 pb-6 border-b border-[#060C120A]">
                    <div className="flex items-center justify-center w-24 h-24 sm:w-35 sm:h-35">
                        <img src={footType1} alt="Footing Type 2 Diagram" className="w-full h-full object-contain" />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-2 gap-2 md:gap-4">
                            ...
                            <InputField
                                ...
                                placeholder={t('steel.footing.d3')}
                            />
                            <InputField
                                unit="mm"
                                value={d4}
                                onChange={(e) => setD4(e.target.value)}
                                placeholder={t('steel.footing.d4')}
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-2 gap-2 md:gap-4">
                            ...
                            <InputField
                                ...
                                placeholder={t('steel.footing.s3')}
                            />
                            <InputField
                                unit="mm"
                                value={s4}
                                onChange={(e) => setS4(e.target.value)}
                                placeholder={t('steel.footing.s4')}
                            />
                        </div>
                    </div>
            ...
            {showResult && (
                <div className="mt-10 animate-fade-in pb-10">
                        ...
                        <table className="w-full text-left border-collapse min-w-[320px]">
                            ...
                            <tbody className="divide-y divide-[#060C120A]">
                                {[
                                    ...
                                    { material: t('steel.footing.d3'), quantity: d3Weight.toFixed(3), unit: 'Kg' },
                                    { material: t('steel.footing.d4'), quantity: d4Weight.toFixed(3), unit: 'Kg' },
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Button
                            variant="primary"
                            onClick={() => navigate(ROUTES_FLAT.CALCULATION_FOOTING_TYPE2_DETAILED, {
                                state: {
                                    calculationData,
                                    outputs: [
                                        { titleKey: 'steel.footing.volume', title: 'Volume', formula: 'XxYxHn/1000000000', value: `${volResult.toFixed(3)} m³` },
                                        { titleKey: 'steel.footing.d1', title: 'D1', formula: 'len1 * nos1 * w1 * n', value: `${d1Weight.toFixed(3)} ${t('history.units.kg')}` },
                                        { titleKey: 'steel.footing.d2', title: 'D2', formula: 'len2 * nos2 * w2 * n', value: `${d2Weight.toFixed(3)} ${t('history.units.kg')}` },
                                        { titleKey: 'steel.footing.d3', title: 'D3', formula: 'len1 * nos1 * w3 * n', value: `${d3Weight.toFixed(3)} ${t('history.units.kg')}` },
                                        { titleKey: 'steel.footing.d4', title: 'D4', formula: 'len2 * nos2 * w4 * n', value: `${d4Weight.toFixed(3)} ${t('history.units.kg')}` },
                                        { titleKey: 'steel.weight.totalWeight', title: 'Total Steel', formula: 'D1 + D2 + D3 + D4', value: `${totalSteel.toFixed(3)} ${t('history.units.kg')}` },
