...
const StackBond = lazy(() => import('../calculation/brickWorkAndPlaster/bond/pages/StackBond'));
const StackBondDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/bond/pages/StackBondDetailed'));
const EnglishCrossBond = lazy(() => import('../calculation/brickWorkAndPlaster/bond/pages/EnglishCrossBond'));
const EnglishCrossBondDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/bond/pages/EnglishCrossBondDetailed'));
const GardenWallBond = lazy(() => import('../calculation/brickWorkAndPlaster/bond/pages/GardenWallBond'));
const GardenWallBondDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/bond/pages/GardenWallBondDetailed'));
const KingCloser = lazy(() => import('../calculation/brickWorkAndPlaster/closerQuantity/pages/KingCloser'));
const KingCloserDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/closerQuantity/pages/KingCloserDetailed'));
const QueenCloser = lazy(() => import('../calculation/brickWorkAndPlaster/closerQuantity/pages/QueenCloser'));
const QueenCloserDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/closerQuantity/pages/QueenCloserDetailed'));
const HalfBatCloser = lazy(() => import('../calculation/brickWorkAndPlaster/closerQuantity/pages/HalfBatCloser'));
const HalfBatCloserDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/closerQuantity/pages/HalfBatCloserDetailed'));
const QuarterBatCloser = lazy(() => import('../calculation/brickWorkAndPlaster/closerQuantity/pages/QuarterBatCloser'));
const QuarterBatCloserDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/closerQuantity/pages/QuarterBatCloserDetailed'));
const ByVolume = lazy(() => import('../calculation/brickWorkAndPlaster/quantity/pages/ByVolume'));
const ByVolumeDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/quantity/pages/ByVolumeDetailed'));
const ShapesByVolume = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/ByVolume'));
const ShapesByVolumeDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/ByVolumeDetailed'));
const ByCube = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/ByCube'));
const ByCubeDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/ByCubeDetailed'));
const ByWall = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/ByWall'));
const ByWallDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/ByWallDetailed'));
const LWall = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/LWall'));
const LWallDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/LWallDetailed'));
const CWall = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/CWall'));
const CWallDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/CWallDetailed'));
const RectangularChamber = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/RectangularChamber'));
const RectangularChamberDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/RectangularChamberDetailed'));
const WallWithDoor = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/WallWithDoor'));
const WallWithDoorDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/WallWithDoorDetailed'));
const WallWithArcDoor = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/WallWithArcDoor'));
const WallWithArcDoorDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/WallWithArcDoorDetailed'));
const CavityWall = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/CavityWall'));
const CavityWallDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/CavityWallDetailed'));
const ButtressWall = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/ButtressWall'));
const ButtressWallDetailed = lazy(() => import('../calculation/brickWorkAndPlaster/shapes/pages/ButtressWallDetailed'));
const RoofAreaPitch = lazy(() => import('../calculation/roofArea/LandingPage/pages/RoofAreaPitch'));
const FlatRoof = lazy(() => import('../calculation/roofArea/roof/pages/FlatRoof'));
const FlatRoofDetailed = lazy(() => import('../calculation/roofArea/roof/pages/FlatRoofDetailed'));
const ShedRoof = lazy(() => import('../calculation/roofArea/roof/pages/ShedRoof'));
const ShedRoofDetailed = lazy(() => import('../calculation/roofArea/roof/pages/ShedRoofDetailed'));
const GableRoof = lazy(() => import('../calculation/roofArea/roof/pages/GableRoof'));
const GableRoofDetailed = lazy(() => import('../calculation/roofArea/roof/pages/GableRoofDetailed'));
const BoxGableRoof = lazy(() => import('../calculation/roofArea/roof/pages/BoxGableRoof'));
const BoxGableRoofDetailed = lazy(() => import('../calculation/roofArea/roof/pages/BoxGableRoofDetailed'));
const MShapedRoof = lazy(() => import('../calculation/roofArea/roof/pages/MShapedRoof'));
const MShapedRoofDetailed = lazy(() => import('../calculation/roofArea/roof/pages/MShapedRoofDetailed'));
const ButterflyRoof = lazy(() => import('../calculation/roofArea/roof/pages/ButterflyRoof'));
const ButterflyRoofDetailed = lazy(() => import('../calculation/roofArea/roof/pages/ButterflyRoofDetailed'));
const SaltboxRoof = lazy(() => import('../calculation/roofArea/roof/pages/SaltboxRoof'));
const SaltboxRoofDetailed = lazy(() => import('../calculation/roofArea/roof/pages/SaltboxRoofDetailed'));
const PyramidHipRoof = lazy(() => import('../calculation/roofArea/roof/pages/PyramidHipRoof'));
const PyramidHipRoofDetailed = lazy(() => import('../calculation/roofArea/roof/pages/PyramidHipRoofDetailed'));
const HexagonalRoof = lazy(() => import('../calculation/roofArea/roof/pages/HexagonalRoof'));
const HexagonalRoofDetailed = lazy(() => import('../calculation/roofArea/roof/pages/HexagonalRoofDetailed'));

const FlooringCalculation = lazy(() => import('../calculation/flooring/LandingPage/pages/FlooringCalculation'));
const Flooring = lazy(() => import('../calculation/flooring/floor/pages/Flooring'));
const FlooringDetailed = lazy(() => import('../calculation/flooring/floor/pages/FlooringDetailed'));
const PaverCalculation = lazy(() => import('../calculation/flooring/floor/pages/PaverCalculation'));
const PaverCalculationDetailed = lazy(() => import('../calculation/flooring/floor/pages/PaverCalculationDetailed'));
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<Layout />}>
            ...
            <Route path={ROUTES_FLAT.CALCULATION_STACK_BOND} element={<StackBond />} />
            <Route path={ROUTES_FLAT.CALCULATION_STACK_BOND_DETAILED} element={<StackBondDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_ENGLISH_CROSS_BOND} element={<EnglishCrossBond />} />
            <Route path={ROUTES_FLAT.CALCULATION_ENGLISH_CROSS_BOND_DETAILED} element={<EnglishCrossBondDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_GARDEN_WALL_BOND} element={<GardenWallBond />} />
            <Route path={ROUTES_FLAT.CALCULATION_GARDEN_WALL_BOND_DETAILED} element={<GardenWallBondDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_KING_CLOSER} element={<KingCloser />} />
            <Route path={ROUTES_FLAT.CALCULATION_KING_CLOSER_DETAILED} element={<KingCloserDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_QUEEN_CLOSER} element={<QueenCloser />} />
            <Route path={ROUTES_FLAT.CALCULATION_QUEEN_CLOSER_DETAILED} element={<QueenCloserDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_HALF_BAT_CLOSER} element={<HalfBatCloser />} />
            <Route path={ROUTES_FLAT.CALCULATION_HALF_BAT_CLOSER_DETAILED} element={<HalfBatCloserDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_QUARTER_BAT_CLOSER} element={<QuarterBatCloser />} />
            <Route path={ROUTES_FLAT.CALCULATION_QUARTER_BAT_CLOSER_DETAILED} element={<QuarterBatCloserDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_BY_VOLUME} element={<ByVolume />} />
            <Route path={ROUTES_FLAT.CALCULATION_BY_VOLUME_DETAILED} element={<ByVolumeDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_VOLUME} element={<ShapesByVolume />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_VOLUME_DETAILED} element={<ShapesByVolumeDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_CUBE} element={<ByCube />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_CUBE_DETAILED} element={<ByCubeDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_WALL} element={<ByWall />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_WALL_DETAILED} element={<ByWallDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_L_WALL} element={<LWall />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_L_WALL_DETAILED} element={<LWallDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_C_WALL} element={<CWall />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_C_WALL_DETAILED} element={<CWallDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_RECTANGULAR_CHAMBER} element={<RectangularChamber />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_RECTANGULAR_CHAMBER_DETAILED} element={<RectangularChamberDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_WALL_WITH_DOOR} element={<WallWithDoor />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_WALL_WITH_DOOR_DETAILED} element={<WallWithDoorDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_WALL_WITH_ARC_DOOR} element={<WallWithArcDoor />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_WALL_WITH_ARC_DOOR_DETAILED} element={<WallWithArcDoorDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_CAVITY_WALL} element={<CavityWall />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_CAVITY_WALL_DETAILED} element={<CavityWallDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_BUTTRESS_WALL} element={<ButtressWall />} />
            <Route path={ROUTES_FLAT.CALCULATION_SHAPES_BY_BUTTRESS_WALL_DETAILED} element={<ButtressWallDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_PITCH} element={<RoofAreaPitch />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_FLAT_ROOF} element={<FlatRoof />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_FLAT_ROOF_DETAILED} element={<FlatRoofDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_SHED_ROOF} element={<ShedRoof />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_SHED_ROOF_DETAILED} element={<ShedRoofDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_GABLE_ROOF} element={<GableRoof />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_GABLE_ROOF_DETAILED} element={<GableRoofDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_BOX_GABLE_ROOF} element={<BoxGableRoof />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_BOX_GABLE_ROOF_DETAILED} element={<BoxGableRoofDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_M_SHAPED_ROOF} element={<MShapedRoof />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_M_SHAPED_ROOF_DETAILED} element={<MShapedRoofDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_BUTTERFLY_ROOF} element={<ButterflyRoof />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_BUTTERFLY_ROOF_DETAILED} element={<ButterflyRoofDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_SALTBOX_ROOF} element={<SaltboxRoof />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_SALTBOX_ROOF_DETAILED} element={<SaltboxRoofDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_PYRAMID_HIP_ROOF} element={<PyramidHipRoof />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_PYRAMID_HIP_ROOF_DETAILED} element={<PyramidHipRoofDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_HEXAGONAL_ROOF} element={<HexagonalRoof />} />
            <Route path={ROUTES_FLAT.CALCULATION_ROOF_AREA_HEXAGONAL_ROOF_DETAILED} element={<HexagonalRoofDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_FLOORING} element={<FlooringCalculation />} />
            <Route path={ROUTES_FLAT.CALCULATION_FLOORING_FLOORING} element={<Flooring />} />
            <Route path={ROUTES_FLAT.CALCULATION_FLOORING_DETAILED} element={<FlooringDetailed />} />
            <Route path={ROUTES_FLAT.CALCULATION_FLOORING_PAVER} element={<PaverCalculation />} />
